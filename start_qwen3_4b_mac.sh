#!/bin/bash
# ZINGO — Qwen3-4B Fast Synthesis Node Launcher (macOS)
# Dedicated fast conversational and quick extraction lane
...
echo "==================================================="
echo "  Starting ZINGO Qwen3-4B Fast Synthesis Node      "
echo "  Model: Qwen3:4b (Fast Lane & Conversational)     "
...
echo "==================================================="
echo "  Qwen3-4B Node is LIVE at https://$PERMANENT_DOMAIN"
echo "==================================================="
